...
# **Description** This notebook defines a set of parameters for use across the data curation pipeline for the CCU018_01 project. This notebook is called at the start of each notebook in the pipleine for consistency. The parameters include variables for the project, databases, study dates, and composite events; and paths to archive, reference, temporary, input, curated, and output tables. 
...
# -----------------------------------------------------------------------------
# maternity files
# note: temporary code - archive files for hes_apc_mat were not available when this project was started)
...
# note: teh brlow is listed in order of appearance within the data curation pipeline:  
...
# Dates
# -----------------------------------------------------------------------------
proj_preg_start_date_min = '2019-08-01' 
proj_preg_start_date_max = '2021-08-01'
# proj_delivery_date_max   = '2021-10-31' # temporary parameter - no longer used 
proj_fu_date_max         = '2021-12-31' 
...
# temporary function to get archive table at the specified productionDate
# note: improved in subsequent pipeline
