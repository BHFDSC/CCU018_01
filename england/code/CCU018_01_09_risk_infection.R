...
writeLines(c("analysis event adj week estimate conf.low conf.high stad.error n.event subgroup"), paste0('C:/ProgramData/UserDataFolders/S-1-5-21-379329792-2760669353-3648467936-1012/My Files/Home Folder/collab/CCU018/CCU018_01/output/out_risk_covid_infection.csv'))
...
if (q == "vaccination_era"){  
  ...
  #this plots the distribution of estimated propensity scores
 ...
 risk_covid <- function(k, y, z) {
  ...
  map2(cov_model, adjustment, function(x,i) {
    ...
    s <- summary(model)
               ...
               collapse = '\n'), '\n', sep = '', file = paste0("C:/ProgramData/UserDataFolders/S-1-5-21-379329792-2760669353-3648467936-1012/My Files/Home Folder/collab/CCU018/CCU018_01/output/out_risk_covid_infection.csv"), append = TRUE)
    invisible(model)
  })
...
out <- read_table2("C:/ProgramData/UserDataFolders/S-1-5-21-379329792-2760669353-3648467936-1012/My Files/Home Folder/collab/CCU018/CCU018_01/output/out_risk_covid_infection.csv")
nrow(out)
out <- out[which(out$n.event > 10),]
out$n.event <- round_any(out$n.event, 5)
nrow(out)
data.table::fwrite(out,"C:/ProgramData/UserDataFolders/S-1-5-21-379329792-2760669353-3648467936-1012/My Files/Home Folder/collab/CCU018/CCU018_01/output/out_risk_covid_infection.csv")
